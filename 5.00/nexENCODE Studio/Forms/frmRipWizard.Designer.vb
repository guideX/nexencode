...
Partial Class frmRipWizard
    ...
    Private Sub InitializeComponent()
        ...
        Me.pnlCurrentStep.SuspendLayout()
        ...
        Me.pnlCurrentStep.ResumeLayout(False)
        Me.pnlCurrentStep.PerformLayout()
    ...
    End Sub
    Friend WithEvents pnlCurrentStep As Telerik.WinControls.UI.RadPanel
    Friend WithEvents RadPanel1 As Telerik.WinControls.UI.RadPanel
    Friend WithEvents cmdNext As Telerik.WinControls.UI.RadButton
    Friend WithEvents cmdFinish As Telerik.WinControls.UI.RadButton
    Friend WithEvents cmdCancel As Telerik.WinControls.UI.RadButton
    Friend WithEvents cmdPrevious As Telerik.WinControls.UI.RadButton
    Friend WithEvents lblStep5 As Telerik.WinControls.UI.RadLabel
    Friend WithEvents lblStep4 As Telerik.WinControls.UI.RadLabel
    Friend WithEvents lblStep3 As Telerik.WinControls.UI.RadLabel
    Friend WithEvents lblStep2 As Telerik.WinControls.UI.RadLabel
    Friend WithEvents lblStep1 As Telerik.WinControls.UI.RadLabel
    Friend WithEvents lblStep0 As Telerik.WinControls.UI.RadLabel
    ...
    Friend WithEvents pnlStep3 As Telerik.WinControls.UI.RadPanel
    ...
    Friend WithEvents pnlStep4 As Telerik.WinControls.UI.RadPanel
    Friend WithEvents RadSeparator4 As Telerik.WinControls.UI.RadSeparator
    Friend WithEvents pnlStep2 As Telerik.WinControls.UI.RadPanel
    ...
    Friend WithEvents pnlStep5 As Telerik.WinControls.UI.RadPanel
    Friend WithEvents RadSeparator7 As Telerik.WinControls.UI.RadSeparator
    Friend WithEvents pnlStep1 As Telerik.WinControls.UI.RadPanel
    Friend WithEvents RadSeparator9 As Telerik.WinControls.UI.RadSeparator
    Friend WithEvents pnlStep6 As Telerik.WinControls.UI.RadPanel
    Friend WithEvents rlvSelectTracks As Telerik.WinControls.UI.RadListView
End Class
