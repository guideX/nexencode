...
#Region "DECLARATIONS"
    ...
    Private WithEvents lCDDrive As New nexENCODE.clsCDDrive
...
#Region "EVENTHANDLERS"
    Private Sub CDDataRead_EventHandler(sender As Object, e As nexENCODE.CDDriveEvents.DataReadEventArgs)
        Try
    ...
    Private Sub CDReadProgress_EventHandler(sender As Object, e As nexENCODE.CDDriveEvents.ReadProgressEventArgs)
        Try
