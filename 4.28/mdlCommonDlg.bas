Attribute VB_Name = "mdlCommonDlg"
Option Explicit
...
Else
    SaveDialog = ""
End If
'If Err.Number <> 0 Then SetError "SaveDialog()", lEvents.eSettings.iErrDescription, Err.Description
End Function
...
If Err.Number <> 0 Then SetError "OpenDialog()", lEvents.eSettings.iErrDescription, Err.Description
End Function
