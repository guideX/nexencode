...
If Err.Number <> 0 Then SetError "GetDirs", lEvents.eSettings.iErrDescription, Err.Description
End Sub
...
Next
cCol.Count = cCol.Path.Count
If Err.Number <> 0 Then SetError "GetSubDirs", lEvents.eSettings.iErrDescription, Err.Description
End Sub
...
Next
cCol.Count = cCol.Path.Count
If Err.Number <> 0 Then SetError "GetFiles", lEvents.eSettings.iErrDescription, Err.Description
End Sub
...
cCol.Count = cCol.Path.Count
If Err.Number <> 0 Then SetError "GetSubFiles", lEvents.eSettings.iErrDescription, Err.Description
End Sub
...
End If
sSplit = nResult
If Err.Number <> 0 Then SetError "sSplit", lEvents.eSettings.iErrDescription, Err.Description
End Function
